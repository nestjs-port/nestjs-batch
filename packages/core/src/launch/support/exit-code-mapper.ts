 ...
 */
export abstract class ExitCodeMapper {
  static readonly JVM_EXITCODE_COMPLETED = 0;
  static readonly JVM_EXITCODE_GENERIC_ERROR = 1;
  static readonly JVM_EXITCODE_JOB_ERROR = 2;
  static readonly NO_SUCH_JOB = "NO_SUCH_JOB";
  static readonly JOB_NOT_PROVIDED = "JOB_NOT_PROVIDED";
   ...
   */
  abstract intValue(exitCode: string): number;
}
